...
class Role extends PureComponent {
  ...
  onCheck = checkedTreeKeys => {
    console.log('checkedTreeKeys', checkedTreeKeys)
    const { dispatch } = this.props;
    dispatch(ROLE_SET_TREE_KEYS({ roleCheckedTreeKeys: checkedTreeKeys.checked }));
  };
    ...
    return (
      <Panel>
        ...
        <Modal
          ...
          cancelText="取消"
        >
          <Tree checkable checkStrictly checkedKeys={roleCheckedTreeKeys} onCheck={this.onCheck}>
