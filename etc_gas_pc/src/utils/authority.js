...
export function setGroups(groups) {
  localStorage.removeItem('gd-groups');
  localStorage.setItem('gd-groups', JSON.stringify(groups));
}

export function getGroups() {
  return JSON.parse(localStorage.getItem('gd-groups')) || [];
}
...
export function removeAll() {
  ...
  localStorage.removeItem('sword-captcha-key');
  sessionStorage.removeItem('printSwitch');
}
